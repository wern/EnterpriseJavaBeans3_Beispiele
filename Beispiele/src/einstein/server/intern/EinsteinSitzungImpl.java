 ...
 *
 */
//TODO: timeout auf 10 Sekunden hochsetzen
...
@Stateful public class EinsteinSitzungImpl implements EinsteinSitzung {
	...
	public int eroeffneTisch(boolean computerGegner) throws SpielException {
		TischEntity neuerTisch = dao.neuerTisch(computerGegner);
